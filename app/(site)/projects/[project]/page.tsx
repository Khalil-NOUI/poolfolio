      ...
      <div className="max-w-3xl mx-auto">
        <div className="flex items-start justify-between mb-4">
          ...
          <a
            ...
            className="bg-secColor text-txtColor border-secColor border hover:border-txtColor rounded-md px-4 py-2"
          >
            Explore
          </a>
        </div>
        ...
        <div className="flex flex-col gap-y-6 m-8 leading-7 text-txtColor">
