    ...
    <main className="max-w-7xl mx-auto md:px-16 px-6">
      <section className="max-w-2xl mb-16">
        ...
        <p className="text-base text-zinc-400 leading-relaxed">
          I&apos;ve worked on a set of amazing projects over the recent time. Many of them are
          open-source, so if you see something that you like, check
          out the project&apos;s respository and share what you think
        </p>
      </section>
